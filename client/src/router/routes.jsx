...
export const pages = [
  ...
  { path: "/logga-in", label: "Logga In", inNav: true, rightNav: true, element: <LoginPage /> },
  { path: "/min-sida", label: "Min Sida", inNav: true, rightNav: true, element: <ProfilePage /> },
  { path: "/registrera", label: "Registera", inNav: true, rightNav: true, element: <RegisterPage /> },
];
